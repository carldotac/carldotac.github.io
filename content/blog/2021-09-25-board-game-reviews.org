...
#+SLUG: board-game-reviews
#+TAGS[]: reviews board-games
#+ALIASES[]: /board-game-reviews/
...
Swingy and replaced by later refinements, but an enjoyable deckbuilding experience.
...
3/5
* Compile
Every game reveals new layers of crunch as card combinations and strategic plays offer exciting ways to gain value or disrupt your opponent.
All of the substance of a competitive card dueler without the predatory business model.

5/5
* Crokinole
Its universal appeal and wow factor aside, it has a wonderful balance of accessibility and skill.
...
3/5
* Go Nuts for Donuts
Simple, inoffensive, dominated by Sushi Go!
...
5/5
* Hive
As someone without the patience to study chess or go, /Hive/ appeals to the part of me that respects their tactical depth.
...
5/5
* Sea Salt & Paper
Impressively tight for its light weight thanks to the tension around when someone will end the round.
...
An impressive adaptation of an excellent video game.
By leaning into its cooperative elements, it does manage to justify its existence.
Upkeep can be a bit much, and a full run is very long, but if a coop roguelike sounds appealing, it will land.
...
5/5
* Splendor: Marvel
Simple tableau-building, but has its place as a gateway.

2/5
* Spots
Lightweight push-your-luck elevated by its art.
I would prefer /Sea Salt & Paper/, but for families or dice-lovers, this has a place.
...
5/5
* Too Many Bones
A tough product to recommend given how content is distributed piecemeal and with redundancy but that the system really does work better with later expansions and revisions.
When it does work, it offers wonderful tactical puzzles on the battlemat with some strategic morsels.
And when it doesn't, you're dead before you get a turn.
...
* Werewords
I'm generally not a fan of hidden role games, and their mechanics here have some rough edges.
